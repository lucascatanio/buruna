...
function ScrollReader({pdf, initialPage, volumeId, brightness, contrast, onPageChange}: ScrollReaderProps) {
        ...
        >
            ...
            >
                ...
                <div className="flex items-center gap-1">
                    ...
                    {mode === "paged" && (
                        <span className="text-white/60 text-xs tabular-nums min-w-[55px] text-right">
                            {currentPage}/{pdf.numPages}
                        </span>
                    )}
                </div>
            ...
            {showSettings && (
                <div
                    className={`
                        shrink-0 bg-black/80 backdrop-blur-sm px-4 py-3 space-y-3
                        transition-all duration-200
